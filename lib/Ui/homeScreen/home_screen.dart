...
import 'package:privilegecare/Ui/homeScreen/widget/home_cell_widget.dart';
import 'package:privilegecare/Ui/homeScreen/widget/home_loader_widget.dart';
                        ...
                        children:  [
                          const Text("التخصصات الأكثر اختيارا",
                            style: TextStyle(
                                ...
                                fontWeight: FontWeight.w700,
                                fontSize: 20),),
                          controller.isLoading?HomeLoaderWidget():Container(
                            width: Get.width*0.9,
                            ...
                            child: RawScrollbar(
                              ...
                              child: ListView.builder(
                                itemCount: controller.specialtyData?.length??0,
                                controller: controllerScroll,
                                itemBuilder: (_,index){
                                  return  HomeCellWidget(title: controller.specialtyData?[index].name??"",imageUrl: "https://privilegecare.net${controller.specialtyData?[index].image}", );
                                },
                              ),
                            ),
                          )
